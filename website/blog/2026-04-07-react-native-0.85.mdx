...
若要启用此功能，你可以[按照此页面中的说明](/docs/release-levels)启用 React Native 的实验性频道。
...
function MyComponent() {
  ...
  return (
    <View style={{flex: 1}}>
      ...
      />
      <Button title="展开" onPress={toggle} />
    </View>
  );
}
```
...
- 我们将 `receiveTouches` 重新添加回 `RCTEventEmitter`，默认为无操作。这是一个修复，旨在减少尚未迁移离开此方法的库的破坏性变更。
...
我们谨向为本次发布做出重大贡献的社区成员表示特别感谢。

- 感谢 [Zeya Peng](https://github.com/zeyap)、[Bartłomiej Błoniarz](https://github.com/bartlomiejbloniarz) 和 [Dawid Małecki](https://github.com/coado) 贡献动画后端
- 感谢 [Vitali Zaidman](https://github.com/vzaidman) 贡献 Metro TLS
- 感谢 [Moti Zilberman](https://github.com/motiz88) 贡献多个 CDP 连接
- 感谢 [Phil Pluckthun](https://github.com/kitten) 和 [Alex Hunt](https://github.com/huntie) 贡献 Jest 预设迁移

此外，我们还要感谢为本次发布撰写功能文档的其他作者：
