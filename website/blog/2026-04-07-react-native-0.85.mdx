...
We’d like to give a special thank you to the community members who made major contributions to this release.

- [Zeya Peng](https://github.com/zeyap), [Bartłomiej Błoniarz](https://github.com/bartlomiejbloniarz), and [Dawid Małecki](https://github.com/coado) for the animation backend
...
Additionally, we’d like to thank the other authors who wrote feature docs for this release:
