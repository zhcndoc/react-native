---
title: 'React Native 0.81 - Support for Android 16, Faster iOS Builds, and More'
authors: [motiz88, vzaidman, gabrieldonadel, chrfalch]
tags: [engineering]
date: 2025-08-12
---

# **React Native 0.81 - Support for Android 16, Faster iOS Builds, and More**
...
- [Support for Android 16](/blog/2025/08/12/react-native-0.81#android-16-support)
...
- [Christian Falch](https://github.com/chrfalch) 因在预编译 iOS 构建方面的出色工作而受到感谢。 {/* // @case-police-ignore Mathieu */}
- [Mathieu Acthernoene](https://github.com/zoontek) 因对 Android edge-to-edge 支持的关键贡献而受到感谢
- [Enrique López-Mañas](https://github.com/kikoso) 以及帮助测试 Android 16 集成和 SafeAreaView 弃用的人。
