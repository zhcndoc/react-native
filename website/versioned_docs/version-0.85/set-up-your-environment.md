...
在本指南中，您将学习如何设置您的环境，以便您可以使用 Android Studio 和 Xcode 运行您的项目。这将使您能够使用 Android 模拟器和 iOS 模拟器进行开发，在本地构建您的应用，等等。
...
如果您有限制阻止您使用框架，或者您想编写自己的框架，那么设置本地环境是必须的。设置好环境后，了解如何 [不使用框架开始](getting-started-without-a-framework)。
