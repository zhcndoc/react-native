...
在 Android Studio 中，您可以通过菜单栏上的 "Run" 选项，点击 "Attach to Process..." 并选择正在运行的 React Native 应用来实现这一点。

### Xcode

在 Xcode 中，点击顶部菜单栏上的 "Debug"，选择 "Attach to process" 选项，然后在 "Likely Targets" 列表中选择应用程序。
