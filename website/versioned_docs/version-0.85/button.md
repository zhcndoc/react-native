...
如果此按钮不适合您的应用，您可以使用 [Pressable](pressable) 构建自己的按钮。灵感请参考 [Button 组件的源代码](https://github.com/facebook/react-native/blob/main/packages/react-native/Libraries/Components/Button.js)。
    ...
    <SafeAreaView style={styles.container}>
      <View>
        <Text style={styles.title}>
          标题和 onPress 处理函数是必需的。建议设置 accessibilityLabel 以帮助让所有人都能使用你的应用。
        </Text>
        <Button
          title="按我"
      ...
      <View>
        <Text style={styles.title}>
          以一种在每个平台上看起来都很标准的方式调整颜色。在 iOS 上，color 属性控制文本颜色。在 Android 上，color 会调整按钮的背景颜色。
        </Text>
        <Button
          title="按我"
          color="#f194ff"
          onPress={() => showAlert('已按下调整颜色的按钮')}
        />
      </View>
      <Separator />
      <View>
...
表示当用户与元素交互时屏幕阅读器应使用哪种语言的值。它应遵循 [BCP 47 规范](https://www.rfc-editor.org/info/bcp47)。
...
指定当用户向下导航时下一个接收焦点的视图。参见 [Android 文档](https://developer.android.com/reference/android/view/View.html#attr_android:nextFocusDown)。
...
指定当用户向前导航时下一个接收焦点的视图。参见 [Android 文档](https://developer.android.com/reference/android/view/View.html#attr_android:nextFocusForward)。
...
指定当用户向左导航时下一个接收焦点的视图。参见 [Android 文档](https://developer.android.com/reference/android/view/View.html#attr_android:nextFocusLeft)。
...
指定当用户向右导航时下一个接收焦点的视图。参见 [Android 文档](https://developer.android.com/reference/android/view/View.html#attr_android:nextFocusRight)。
...
指定当用户向上导航时下一个接收焦点的视图。参见 [Android 文档](https://developer.android.com/reference/android/view/View.html#attr_android:nextFocusUp)。
