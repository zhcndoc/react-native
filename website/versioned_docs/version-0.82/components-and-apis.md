...
React Native 提供了许多内置的 [核心组件](intro-react-native-components)，供你在应用中使用。你可以在左侧边栏（如果在窄屏上则在上方菜单）中找到它们。如果你不确定从哪里开始，请查看以下类别：
...
你并不局限于 React Native 捆绑的组件和 API。React Native 拥有一个数千名开发者的社区。如果你在寻找特定功能的库，请参考 [这份关于寻找库的指南](libraries#finding-libraries)。
...
<div className="component-grid component-grid-border">
  <div className="component">
    <a href="./button">
      <h3>Button</h3>
      <p>一个基本的按钮组件，用于处理触摸，在任何平台上都应该渲染得很好。</p>
    </a>
  </div>
  <div className="component">
    <a href="./switch">
...
与更通用的 [`ScrollView`](./scrollview) 不同，以下列表视图组件仅渲染当前屏幕上显示的元素。这使得它们成为显示长数据列表的性能选择。
...
这些组件可能对某些应用有用。有关组件和 API 的详尽列表，请查看左侧边栏（如果在窄屏上则为上方菜单）。
...
<div className="component-grid">
  ...
  <div className="component">
    <a href="./keyboardavoidingview">
      ...
      <p>提供一个会自动移开以避开虚拟键盘的视图。</p>
    </a>
  </div>
  <div className="component">
    <a href="./linking">
      <h3>Linking</h3>
      <p>提供一个通用接口来与传入和传出的应用链接进行交互。</p>
    </a>
  </div>
  <div className="component">
    <a href="./modal">
      <h3>Modal</h3>
      <p>提供一种简单的方法在封闭视图上方呈现内容。</p>
    </a>
  </div>
  <div className="component">
    <a href="./pixelratio">
  ...
  <div className="component">
    <a href="./refreshcontrol">
      ...
      <p>此组件在 <code>ScrollView</code> 内部使用，用于添加下拉刷新功能。</p>
    </a>
  </div>
  <div className="component">
    <a href="./statusbar">
