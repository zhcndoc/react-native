...
[Hermes](https://hermesengine.dev) 是一个专为 React Native 优化的开源 JavaScript 引擎。对于许多应用而言，与 JavaScriptCore 相比，使用 Hermes 将带来更快的启动时间、更低的内存占用和更小的应用体积。
...
:::caution
如果您使用非标准方式加载 JS bundle，`HermesInternal` 变量可能可用，但您可能并未使用高度优化的预编译字节码。
...
React Native 还支持使用 JavaScriptCore 作为 [JavaScript 引擎](javascript-environment)。遵循 [社区仓库](https://github.com/react-native-community/javascriptcore) 中的说明以选择不使用 Hermes。
