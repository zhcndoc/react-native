...
通常生成的代码不包含在库中，使用该库的应用负责在构建时运行 Codegen。
...
- 生成的代码将使用库内部定义的 React Native 版本。所以如果你的库发布时带有 React Native 0.76，生成的代码将基于该版本。这可能意味着生成的代码与使用 **之前** React Native 版本的应用不兼容（例如，运行在 React Native 0.75 上的应用）。
