...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/align-content) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/align-items) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/align-self) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/aspect-ratio) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/border-bottom-width) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/border-left-width) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/border-right-width) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/border-top-width) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/border-width) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/bottom) 以获取更多关于 `bottom` 如何影响布局的详情。
...
`boxSizing` 定义如何计算元素的各种尺寸属性（`width`、`height`、`minWidth`、`minHeight` 等）。如果 `boxSizing` 为 `border-box`，这些尺寸适用于元素的边框盒。如果为 `content-box`，它们适用于元素的内容盒。默认值为 `border-box`。如果你希望了解更多关于此属性如何工作的信息，[Web 文档](https://developer.mozilla.org/en-US/docs/Web/CSS/box-sizing) 是一个很好的信息来源。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/column-gap) 以获取更多详情。
...
详见 [MDN CSS 参考](https://www.yogalayout.dev/docs/styling/layout-direction) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/flex-direction) 以获取更多详情。
...
[`flexShrink`](layout-props#flexshrink) 描述在子元素的总大小溢出容器主轴大小的情况下，如何沿主轴收缩子元素。`flexShrink` 与 `flexGrow` 非常相似，如果任何溢出大小被视为负剩余空间，则可以以相同的方式思考。这两个属性也可以很好地配合工作，允许子元素根据需要增长和收缩。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/flex-wrap) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/gap) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/height) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/inset) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/inset-block) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/inset-block-end) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/inset-block-start) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/inset-inline) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/inset-inline-end) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/inset-inline-start) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/justify-content) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/left) 以获取更多关于 `left` 如何影响布局的详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/margin) 以获取更多详情。
...
`marginBottom` 的工作方式类似于 CSS 中的 `margin-bottom`。详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-bottom) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/margin-block) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/margin-block-end) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/margin-block-start) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/margin-inline) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/margin-inline-end) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/margin-inline-start) 以获取更多详情。
...
`marginLeft` 的工作方式类似于 CSS 中的 `margin-left`。详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-left) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-right) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-top) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/max-height) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/max-width) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/min-height) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/min-width) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/overflow) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/padding) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-bottom) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/padding-block) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/padding-block-end) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/padding-block-start) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/padding-inline) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/padding-inline-end) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/padding-inline-start) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-left) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-right) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-top) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/right) 以获取更多关于 `right` 如何影响布局的详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/row-gap) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/top) 以获取更多关于 `top` 如何影响布局的详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/width) 以获取更多详情。
...
详见 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/z-index) 以获取更多详情。
