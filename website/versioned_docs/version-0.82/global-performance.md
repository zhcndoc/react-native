...
全局 [`performance`](https://developer.mozilla.org/en-US/docs/Web/API/Window/performance) 对象，如 Web 规范中所定义。
...
| `executeJavaScriptBundleEntryPointStart` | number \| void | 应用 bundle 执行开始的时间。 |
