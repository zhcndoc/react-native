...
Codegen CLI 是库开发人员的好工具。它可用于预览生成的代码，查看你需要实现哪些接口。
...
- 生成的代码将使用库内部定义的 React Native 版本。因此，如果你的库发布时包含 React Native 0.76，生成的代码将基于该版本。这可能意味着生成的代码与使用 **之前** React Native 版本的 app 不兼容（例如，运行在 React Native 0.75 上的 App）。
