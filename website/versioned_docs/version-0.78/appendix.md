...
- **原生模块** - 没有用户界面 (UI) 的原生库。例如持久存储、通知、网络事件。这些作为函数和对象对你的 JavaScript 应用代码可见。
- **原生组件** - 通过 React 组件对你的应用 JavaScript 代码可用的原生平台视图。
...
| <code>Array&lt;T&gt;</code>                                                | <code>Array&lt;T&gt;</code>                         | <code>?Array&lt;T&gt;</code>                            | <code>Array&lt;T&gt; &#124; null</code>              | `ReadableArray`                      | `NSArray` (或在对象内使用时为 `RCTConvertVecToArray`) |
