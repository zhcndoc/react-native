...
above 是一个 Snack Player。它是 Expo 创建的一个方便的工具，用于嵌入和运行 React Native 项目，并分享它们在 Android 和 iOS 等平台上的渲染方式。代码是实时可编辑的，所以您可以在浏览器中直接操作它。继续尝试将上面的 "Try editing me!" 文本更改为 "Hello, world!"
