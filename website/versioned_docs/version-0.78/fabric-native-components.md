...
你的规范必须定义在 [TypeScript](https://www.typescriptlang.org/) 或 [Flow](https://flow.org/) 中（详见 [Codegen](the-new-architecture/what-is-codegen) 文档）。Codegen 使用它来生成 C++、Objective-C++ 和 Java 代码，以将你的平台代码连接到 React 运行的 JavaScript 运行时。
