...
接下来，选择 "SDK Tools" 选项卡，并同样勾选此处 "Show Package Details" 旁边的复选框。查找并展开 "Android SDK Build-Tools" 条目，然后确保选中 `36.0.0` 和 `Android SDK Command-line Tools (latest)`。
...
如果你拥有物理 Android 设备，可以通过 USB 电缆将其连接到电脑，并按照 [此处](running-on-device.md) 的说明使用它进行开发，以代替 AVD。
