...
:::tip
虽然源代码映射 (source maps) 默认可能未启用，但您可以遵循 [本指南](https://blog.nparashuram.com/2019/10/debugging-react-native-ios-apps-with.html) 或 [视频](https://www.youtube.com/watch?v=GrGqIIz51k4) 来启用它们，并在源代码中的正确位置设置断点。
:::
...
:::warning 重要
远程 JavaScript 调试已在 React Native 0.79 版本中被移除。请参阅原始 [弃用公告](https://github.com/react-native-community/discussions-and-proposals/discussions/734)。
