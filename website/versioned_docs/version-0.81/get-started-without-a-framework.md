...
如果你是将 React Native 集成到现有应用中，或者已在项目中安装了 [Expo](https://docs.expo.dev/bare/installing-expo-modules/)，或者是在现有 React Native 项目中添加 Android 支持（参见 [与现有应用集成](integration-with-existing-apps.md)），则不需要执行此操作。你也可以使用第三方 CLI 来设置 React Native 应用，例如 [Ignite CLI](https://github.com/infinitered/ignite)。
...
- 按两次 <kbd>R</kbd> 键或从开发菜单中选择 `Reload`（<kbd>Ctrl</kbd> + <kbd>M</kbd>）以查看你的更改！
