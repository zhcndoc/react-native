...
React Native 中的组件使用 [JavaScript 进行样式设置](style)。颜色属性通常与 [CSS 在网页上的工作方式](https://developer.mozilla.org/en-US/docs/Web/CSS/color_value) 相匹配。可以在下面找到关于每个平台上颜色使用的通用指南：
