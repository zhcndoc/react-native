...
- `dropShadow` 是一个 Alpha 遮罩，因此只有具有正 Alpha 值的像素才会“投射”阴影。`boxShadow` 将围绕元素的边框盒投射阴影，无论其内容如何（除非它是内嵌的）。
...
请参阅 [View 样式属性](./view-style-props#boxshadow) 以获取文档。

### `dropShadow` <div className="label android">Android</div>

请参阅 [View 样式属性](./view-style-props#filter) 以获取文档。
