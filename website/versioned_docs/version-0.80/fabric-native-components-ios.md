...
2. 右键点击应用并选择 <code>New Group</code>，将新组命名为 `WebView`。

<img className="half-size" alt="右键点击应用并选择 New Group" src="/docs/assets/fabric-native-components/2.webp" />
...
- `updateProps` 方法，当组件的 props 改变时由 React Native 调用；
