...
:::note
本指南需要 Android Studio 或 Xcode。如果您已经安装了其中一个程序，您应该能够在几分钟内完成设置并开始运行。如果未安装，您应该预计花费大约一个小时来安装和配置它们。
...
如果您有约束阻止您使用框架，或者您想编写自己的框架，那么设置本地环境是必须的。设置好环境后，学习如何 [不使用框架开始](getting-started-without-a-framework)。
...
> 构建带有 iOS 原生代码的项目需要 Mac 电脑。您可以使用 [Expo](environment-setup#start-a-new-react-native-project-with-expo) 的 [Expo Go](https://expo.dev/go) 在您的 iOS 设备上开发应用。
