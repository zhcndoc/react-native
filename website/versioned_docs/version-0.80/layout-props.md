...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/align-content) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/align-items) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/align-self) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/aspect-ratio) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/border-bottom-width) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/border-left-width) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/border-right-width) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/border-top-width) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/border-width) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/bottom) 了解更多关于 `bottom` 如何影响布局的详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/column-gap) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://www.yogalayout.dev/docs/styling/layout-direction) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/flex-direction) 了解更多详情。
...
[`flexShrink`](layout-props#flexshrink) 描述在子元素的总大小溢出容器主轴大小的情况下，如何沿主轴缩小子元素。`flexShrink` 与 `flexGrow` 非常相似，如果任何溢出大小被视为负剩余空间，则可以以相同的方式思考。这两个属性也可以很好地配合使用，允许子元素根据需要增长和缩小。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/flex-wrap) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/gap) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/height) 了解更多详情。
...
设置 `inset` 具有与设置 `top`、`bottom`、`right` 和 `left` 属性相同的效果。

请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/inset) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/inset-block) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/inset-block-end) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/inset-block-start) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/inset-inline) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/inset-inline-end) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/inset-inline-start) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/justify-content) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/left) 了解更多关于 `left` 如何影响布局的详情。
...
设置 `margin` 具有与设置 `marginTop`、`marginLeft`、`marginBottom` 和 `marginRight` 相同的效果。

请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/margin) 了解更多详情。
...
`marginBottom` 的工作方式类似于 CSS 中的 `margin-bottom`。请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-bottom) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/margin-block) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/margin-block-end) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/margin-block-start) 了解更多详情。
...
设置 `marginHorizontal` 具有与同时设置 `marginLeft` 和 `marginRight` 相同的效果。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/margin-inline) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/margin-inline-end) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/margin-inline-start) 了解更多详情。
...
`marginLeft` 的工作方式类似于 CSS 中的 `margin-left`。请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-left) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-right) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-top) 了解更多详情。
...
设置 `marginVertical` 具有与同时设置 `marginTop` 和 `marginBottom` 相同的效果。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/max-height) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/max-width) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/min-height) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/min-width) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/overflow) 了解更多详情。
...
设置 `padding` 具有与设置 `paddingTop`、`paddingBottom`、`paddingLeft` 和 `paddingRight` 相同的效果。

请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/padding) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-bottom) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/padding-block) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/padding-block-end) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/padding-block-start) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/padding-inline) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/padding-inline-end) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/padding-inline-start) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-left) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-right) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-top) 了解更多详情。
...
React Native 中的 `position` 类似于 [常规 CSS](https://developer.mozilla.org/en-US/docs/Web/CSS/position)，但所有内容默认设置为 `relative`。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/right) 了解更多关于 `right` 如何影响布局的详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/row-gap) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/top) 了解更多关于 `top` 如何影响布局的详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/width) 了解更多详情。
...
请参阅 [MDN CSS 参考](https://developer.mozilla.org/en-US/docs/Web/CSS/z-index) 了解更多详情。
