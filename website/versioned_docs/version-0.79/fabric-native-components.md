...
如果你想构建 _新的_ React Native 组件，包裹一个 [宿主组件](https://reactnative.dev/architecture/glossary#host-view-tree-and-host-view)，比如 Android 上一种独特的 [CheckBox](https://developer.android.com/reference/androidx/appcompat/widget/AppCompatCheckBox)，或者 iOS 上的 [UIButton](https://developer.apple.com/documentation/uikit/uibutton?language=objc)，你应该使用 Fabric 原生组件。
...
该规范被 React Native 的 Codegen 工具用于为我们生成平台特定的接口和样板代码。为此，Codegen 需要知道在哪里找到我们的规范以及如何处理它。更新你的 `package.json` 以包含：
...
一切为 Codegen 连接好后，我们需要准备原生代码以挂钩到生成的代码。
