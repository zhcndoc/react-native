...
一旦你安装并配置了依赖项，你就可以继续设置项目以使用 React Navigation。

使用 React Navigation 时，你在应用中配置 [导航器](https://reactnavigation.org/docs/glossary-of-terms#navigator)。导航器处理应用中屏幕之间的转换，并提供诸如标题栏、标签栏等 UI。
