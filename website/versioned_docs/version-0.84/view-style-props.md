...
`filter` 接受由包含上述滤镜函数的对象组成的数组，或模拟 [Web 语法](https://developer.mozilla.org/en-US/docs/Web/CSS/filter#syntax) 的字符串。
...
:::note
`mixBlendMode` 仅在 [新架构](/architecture/landing-page) 和 **Android 10 及以上** 可用
:::
