...
`matrix` 变换接受一个 4x4 变换矩阵，作为包含16个数字的数组传入。它允许你在一次操作中组合平移、旋转、缩放和倾斜等复杂变换。
...
你也可以参考 MDN 关于 [Transform origin](https://developer.mozilla.org/en-US/docs/Web/CSS/transform-origin) 的相关指南获取更多信息。
