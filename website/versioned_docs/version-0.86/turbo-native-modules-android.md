...
title: 'Turbo Native 模块：Android'
---

import Tabs from '@theme/Tabs'; import TabItem from '@theme/TabItem'; import constants from '@site/core/TabsConstants';

现在是时候编写一些 Android 平台代码，以确保 `localStorage` 在应用关闭后仍能保留。
...
接下来我们需要创建 `NativeLocalStoragePackage`。它通过将模块包装为 Base Native Package，为我们在 React Native 运行时注册模块提供了一个对象：
...
最后，我们需要告诉主应用中的 React Native 如何找到这个 `Package`。我们把这称为在 React Native 中“注册”该包。

在这种情况下，你需要将其添加到 [getPackages](https://github.com/facebook/react-native/blob/8d8b8c343e62115a5509e1aed62047053c2f6e39/packages/react-native/ReactAndroid/src/main/java/com/facebook/react/ReactNativeHost.java#L233) 方法返回的列表中。

:::info
之后你会学到如何将你的原生模块作为 [npm 包](the-new-architecture/create-module-library.mdx#publish-the-library-on-npm) 发布，我们的构建工具会为你自动链接它们。
:::
