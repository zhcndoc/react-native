...
建议使用 Node 的 LTS 版本。如果你想在不同版本之间切换，可能想通过 [nvm-windows](https://github.com/coreybutler/nvm-windows) 安装 Node，这是一个 Windows 的 Node 版本管理器。
...
- 如果你尚未使用 Hyper-V：`Performance (Intel ® HAXM)` ([关于 AMD 或 Hyper-V 请参阅此处](https://android-developers.googleblog.com/2018/07/android-emulator-amd-processor-hyper-v.html))
