...
本指南将向您展示如何编写 [Web 存储 API](https://html.spec.whatwg.org/multipage/webstorage.html#dom-localstorage-dev) 的实现：`localStorage`。该 API 对于可能在您的项目上编写应用程序代码的 React 开发者来说是熟悉的。
...
:::note
本指南向您展示如何创建仅适用于新架构的 Turbo 原生模块。如果您需要同时支持新架构和旧架构，请参阅我们的 [向后兼容指南](https://github.com/reactwg/react-native-new-architecture/blob/main/docs/backwards-compat.md)。
:::
