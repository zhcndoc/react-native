...
React Native 每次构建 iOS 或 Android 应用时都会自动调用 **Codegen**。偶尔，你可能想要手动运行 **Codegen** 脚本，以了解实际生成了哪些类型和文件：这在开发 Turbo Native Modules 和 Fabric Native Components 时是一个常见场景。
