...
React Native 提供了许多内置的 [核心组件](intro-react-native-components) 供你在应用中使用。你可以在左侧边栏（如果你使用的是窄屏，则在上方菜单中）找到它们。如果你不确定从哪里开始，请查看以下类别：
...
你并不局限于 React Native 捆绑的组件和 API。React Native 拥有一个数千名开发者的社区。如果你在寻找一个能实现特定功能的库，请参考 [这份关于寻找库的指南](libraries#finding-libraries)。
...
<div className="component-grid component-grid-border">
  ...
  <div className="component">
    <a href="./pressable">
      <h3>Pressable</h3>
      <p>一个包装组件，可以检测其任何子元素上的各种按压交互阶段。</p>
    </a>
  </div>
  <div className="component">
    <a href="./scrollview">
...
<div className="component-grid component-grid-border">
  <div className="component">
    <a href="./button">
      <h3>Button</h3>
      <p>一个基础按钮组件，用于处理触摸，应在任何平台上都能良好渲染。</p>
    </a>
  </div>
  <div className="component">
    <a href="./switch">
...
与更通用的 [`ScrollView`](./scrollview) 不同，以下列表视图组件仅渲染当前屏幕上显示的元素。这使得它们成为显示长数据列表的高性能选择。
...
<div className="component-grid component-grid-border">
  ...
  <div className="component">
    <a href="./sectionlist">
      <h3>SectionList</h3>
      <p>类似于 <code>FlatList</code>，但用于分段列表。</p>
    </a>
  </div>
</div>
...
这些组件可能对某些应用有用。有关组件和 API 的详尽列表，请查看左侧边栏（如果你使用的是窄屏，则查看上方菜单）。
...
<div className="component-grid">
  ...
  <div className="component">
    <a href="./refreshcontrol">
      ...
      <p>此组件用于 <code>ScrollView</code> 内部以添加下拉刷新功能。</p>
    </a>
  </div>
  <div className="component">
    <a href="./statusbar">
